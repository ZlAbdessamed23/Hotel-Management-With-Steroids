  ...
  return (
    <div className='h-screen w-screen overflow-x-hidden bg-gray-50 text-black relative font-sans auth-page p-b-10  dark:bg-black dark:text-white'>
      <section className='absolute left-0 w-full sm:left-[10%] top-[25%] md:w-[35rem] p-4'>
        <p className='font-bold text-3xl lg:text-5xl text-center mb-8'>Bonjour</p>
        <p className='text-2xl lg:text-4xl font-medium text-center leading-10'>Veuillez saisir vos informations pour accéder à notre système de gestion hôtelière et optimiser votre flux de travail.</p>
