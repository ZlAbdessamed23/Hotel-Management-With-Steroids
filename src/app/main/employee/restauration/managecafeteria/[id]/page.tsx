...
export default function RestauMenuPage({ params }: {
    ...
    const fetchData = React.useCallback(async () => {
        try {
            setIsLoading(true);
            const response = await getAllCafeteriaMenuItems(params.id);
    ...
    return (
        <CafeteriaMenuProvider fetchTrigger={fetchTrigger} setFetchTrigger={setFetchTrigger} cafeteriaMenuId={params.id} fetchType='cafeteria'>
            <div>
