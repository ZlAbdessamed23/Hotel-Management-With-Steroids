...
export default function StockHeroSection({StatisticsFetchFunc} : {
  ...
  return (
    <div className='mb-[33rem] md:mb-40'>
        <section className='text-white relative '>
            <div className='w-full h-64 p-4 grid grid-cols-[75%,25%] bg-gradient-to-r from-blue-900 to-blue-600 rounded-xl relative'>
                <span>
                    <h1 className='text-5xl font-medium mb-4'>Stock Management</h1>
                    <p className='text-xl font-medium pl-8 mb-12'>Vous gérez tout le Stock dans cette section et avez une réflexion approfondie pour organiser votre travail</p>
                </span>
                <span>
                    <Image src={StockHeroImage} alt='' width={300} height={300} className='absolute -top-[15%]'/>
                </span>
            </div>
            <div className='grid grid-rows-3 lg:grid-rows-none gap-4 lg:grid-cols-3 items-center mb-12 text-black absolute top-56 w-full pl-10'>
                {
