...
import DeleteConfirmationModal from "../modals/forms/DeleteConfirmationModal";
...
const GanttChart: React.FC<GanttChartProps> = ({ events }) => {
  ...
  return (
    <div className="rounded-xl p-4 bg-white shadow-lg dark:bg-slate-800">
      ...
      <DeleteConfirmationModal dataType="event" itemId={selectedData?.id as string} props={DeleteModal} eventId={selectedData?.eventId}  />
    </div>
  );
};
