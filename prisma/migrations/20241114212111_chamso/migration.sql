...
-- CreateEnum
CREATE TYPE "RoomStatus" AS ENUM ('disponible', 'reservee', 'hors_service', 'en_panne');
...
-- AddForeignKey
ALTER TABLE "Budget" ADD CONSTRAINT "Budget_stockId_fkey" FOREIGN KEY ("stockId") REFERENCES "Stock"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
